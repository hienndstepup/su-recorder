-- Drop existing function to resolve function overloading conflict
DROP FUNCTION IF EXISTS update_profile_info(UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
DROP FUNCTION IF EXISTS update_profile_info(UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, BOOLEAN);

-- Create the updated function with all parameters
